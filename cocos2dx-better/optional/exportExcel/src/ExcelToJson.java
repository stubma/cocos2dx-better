...
public class ExcelToJson {
	...
	private void generateCpp(File xlsFile, String className, Sheet sheet) {
		...
		hfile.append("// Auto generated by exportExcel, don't modify it\n")
			...
			.append("\tstatic " + className + "* create(const string& key);\n")
			.append("\tstatic " + className + "* create(int index);\n")
			...
			.append("\tvirtual bool initWithKey(const string& key);\n")
		...
		StringBuilder cfile = new StringBuilder()
			...
			.append("}\n")
			.append("\n")
			.append(className + "* " + className + "::create(const string& key) {\n")
			.append("\tensureLoaded();\n")
			.append("\tif(sJSON.isMember(key)) {\n")
			...
			.append("}\n")
			.append("\n")
			.append(className + "* " + className + "::create(int index) {\n")
			.append("\tensureLoaded();\n")
			...
			.append("}\n")
			.append("\n")
			.append("bool " + className + "::initWithKey(const string& key) {\n")
			.append("\treturn initWithValue(sJSON[key]);\n")
			.append("}\n")
			.append("\n")
