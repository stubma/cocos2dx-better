...
void CommonRichLabel::onEnter()
{
    ...
    label = CCRichLabelTTF::create("Hello, [image=Images/a.png w=64 h=32 offsety=-32]blo[i]c[/i]ks[/image], [u]Grossini[/u][image=Images/grossini.png scaley=0.5 scalex=0.3]grossini[/image]\nThis is second line",
                                   "Helvetica",
                                   20);
	label->setPosition(ccp(origin.x + visibleSize.width / 2,
